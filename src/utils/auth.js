...
const auth = isBrowser
  ? new auth0.WebAuth({
      ...
      redirectUri: "https://www.futureleadershiptutoringservice.com/us/callback", //process.env.AUTH0_CALLBACK,
...
export const lock = isBrowser
    ? new Auth0Lock('Qy7y5utJXi9uKlwT962PTeDXFTmXCJvu', 'future-eng.us.auth0.com', {
              ...
              auth: {
                  ...
                  redirectUrl: 'https://www.futureleadershiptutoringservice.com/us/profile', //'http://localhost:8000/us/profile',//
                  responseType: 'token id_token',
                  autoParseHash: false,
                  params: {
